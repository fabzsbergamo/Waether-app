...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      <img src={logo} alt="hoobank" className="w-[85px] h-[80px]" />
      <h1 className="flex-1 font-poppins font-semibold ml-2 ss:text-[72px] text-[25px] text-white ss:leading-[100.8px] leading-[75px] text-gradient">WEATHER-APP</h1>
